pipeline {
  agent {
    ...
    environment {
      NO_COLOR = "true"
      MACHINE_DNS = 'http://internal-btq-pen-test-26-v2.btq.sealights.co:8081'
    }
    options{
    ...
    stages{
        stage("Init test"){
            steps{
                script{
                git branch: params.BRANCH, url: 'https://github.com/Sealights-btq/btq-pen-test-26-v2-btq.git'
                }
            }
        }
        stage("Setup pnpm") {
